...
<div class="contentContainer">
  <div class="contentText">
      <div class="control-group">
          ...
          <div class="controls">
              <?php echo osc_draw_input_field('name', null, 'id="name" placeholder="'.ENTRY_NAME.'"' ); ?>
          </div>
      </div>
      <div class="control-group">
          <label class="control-label" for="email"><?php echo ENTRY_EMAIL; ?></label>
          <div class="controls">
              <?php echo osc_draw_input_field('email', null, 'id="email" placeholder="'.ENTRY_EMAIL.'"' ); ?>
          </div>
      </div>
      <div class="control-group">
          <label class="control-label" for="email"><?php echo ENTRY_ENQUIRY; ?></label>
          <div class="controls">
              <?php echo osc_draw_textarea_field('enquiry', 'soft', 50, 15); ?>
          </div>
      </div>
  </div>
